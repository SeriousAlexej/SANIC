...
public:
    ...
    inline GLuint  getProjMatrixID() const         { return projMatrixID; }
    inline GLuint  getViewMatrixID() const         { return viewMatrixID; }
    inline GLuint  getModlMatrixID() const         { return modlMatrixID; }
    ...
    inline GLuint  getOverlayBoolID() const        { return overlayBool; }
    inline GLuint  getTranslucencyAlphaID() const  { return translucencyAlpha; }
    inline GLuint  getTimeID() const               { return timeID; }
    inline GLuint  getUseImageAlphaID() const      { return useImageAlphaID; }
...
private:
    ...
    GLuint        UVTilingH;
    GLuint        overlayBool;
    GLuint        translucencyAlpha;
    GLuint        useImageAlphaID;
};
